...
- Как изменилась метрика
- Страница загружается примерно за 220 ms ms
- Как изменился отчёт профилировщика - исправленная проблема перестала быть главной точкой роста?
- Для меня, если честно это оказалось ШОК-контентом, я даже не думал что вставка ERB шаблонов такая долгая... Мне кажеться нужно смотреть и пытаться всё-таки оптимизировать это кэшированием. Т.к если писать всё в одном шаблоне, то будет сложно поддерживать код...